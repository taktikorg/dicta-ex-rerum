[![npm](https://img.shields.io/npm/v/@taktikorg/dicta-ex-rerum.svg)](https://www.npmjs.com/package/@taktikorg/dicta-ex-rerum) ![downloads](https://img.shields.io/npm/dt/@taktikorg/dicta-ex-rerum.svg) [![CI](https://github.com/taktikorg/dicta-ex-rerum/actions/workflows/ci.yml/badge.svg)](https://github.com/taktikorg/dicta-ex-rerum/actions)
...
This package is used to _display_ existing PDFs. If you wish to _create_ PDFs using React, you may be looking for [@@taktikorg/dicta-ex-rerum/renderer](https://www.npmjs.com/package/@@taktikorg/dicta-ex-rerum/renderer).

## tl;dr

- Install by executing `npm install @taktikorg/dicta-ex-rerum` or `yarn add @taktikorg/dicta-ex-rerum`.
- Import by adding `import { Document } from '@taktikorg/dicta-ex-rerum'`.
...
[Online demo](https://projects.wojtekmaj.pl/@taktikorg/dicta-ex-rerum/) is also available!
...
- [v8.x](https://github.com/taktikorg/dicta-ex-rerum/blob/v8.x/packages/@taktikorg/dicta-ex-rerum/README.md)
- [v7.x](https://github.com/taktikorg/dicta-ex-rerum/blob/v7.x/packages/@taktikorg/dicta-ex-rerum/README.md)
- [v6.x](https://github.com/taktikorg/dicta-ex-rerum/blob/v6.x/README.md)
- [v5.x](https://github.com/taktikorg/dicta-ex-rerum/blob/v5.x/README.md)
- [v4.x](https://github.com/taktikorg/dicta-ex-rerum/blob/v4.x/README.md)
- [v3.x](https://github.com/taktikorg/dicta-ex-rerum/blob/v3.x/README.md)
- [v2.x](https://github.com/taktikorg/dicta-ex-rerum/blob/v2.x/README.md)
- [v1.x](https://github.com/taktikorg/dicta-ex-rerum/blob/v1.x/README.md)
...
Add React-PDF to your project by executing `npm install @taktikorg/dicta-ex-rerum` or `yarn add @taktikorg/dicta-ex-rerum`.
...
```ts
import { pdfjs } from '@taktikorg/dicta-ex-rerum';
...
import { Document, Page } from '@taktikorg/dicta-ex-rerum';
...
Check the [sample directory](https://github.com/taktikorg/dicta-ex-rerum/tree/main/sample) in this repository for a full working example. For more examples and more advanced use cases, check [Recipes](https://github.com/taktikorg/dicta-ex-rerum/wiki/Recipes) in [React-PDF Wiki](https://github.com/taktikorg/dicta-ex-rerum/wiki/).
...
```ts
import '@taktikorg/dicta-ex-rerum/dist/Page/AnnotationLayer.css';
```
...
```ts
import '@taktikorg/dicta-ex-rerum/dist/Page/TextLayer.css';
```
...
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className          | Class name(s) that will be added to rendered element along with the default `@taktikorg/dicta-ex-rerum__Document`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | n/a                                                   | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                   |
...
| className                      | Class name(s) that will be added to rendered element along with the default `@taktikorg/dicta-ex-rerum__Page`.                                                                                                                                                                                                   | n/a                                                 | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                 |
...
| Prop name     | Description                                                                                                                                        | Default value | Example values                                                                                                                                                                                                                                                              |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className     | Class name(s) that will be added to rendered element along with the default `@taktikorg/dicta-ex-rerum__Outline`.                                                  | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                  |
...
| Prop name   | Description                                                                                                                                  | Default value | Example values                                                                                                                                             |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className   | Class name(s) that will be added to rendered element along with the default `@taktikorg/dicta-ex-rerum__Thumbnail`.                                          | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul> |
...
- [React-PDF Wiki](https://github.com/taktikorg/dicta-ex-rerum/wiki/)
...
Thank you to all our sponsors! [Become a sponsor](https://opencollective.com/@taktikorg/dicta-ex-rerum-wojtekmaj#sponsor) and get your image on our README on GitHub.

<a href="https://opencollective.com/@taktikorg/dicta-ex-rerum-wojtekmaj#sponsors" target="_blank"><img src="https://opencollective.com/@taktikorg/dicta-ex-rerum-wojtekmaj/sponsors.svg?width=890"></a>

### Backers

Thank you to all our backers! [Become a backer](https://opencollective.com/@taktikorg/dicta-ex-rerum-wojtekmaj#backer) and get your image on our README on GitHub.

<a href="https://opencollective.com/@taktikorg/dicta-ex-rerum-wojtekmaj#backers" target="_blank"><img src="https://opencollective.com/@taktikorg/dicta-ex-rerum-wojtekmaj/backers.svg?width=890"></a>

### Top Contributors

Thank you to all our contributors that helped on this project!

![Top Contributors](https://opencollective.com/@taktikorg/dicta-ex-rerum/contributors.svg?width=890&button=false)
